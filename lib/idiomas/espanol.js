...
const methodCode1 = () => { return `MÉTODO DE VINCULACIÓN` }
const methodCode2 = () => { return `¿CÓMO DESEA CONECTARSE?` }
const methodCode3 = () => { return `Opción` }
const methodCode4 = () => { return `Código QR` }
const methodCode5 = () => { return `Código de 8 digitos.` }
const methodCode6 = () => { return `Escriba sólo el número de` }
const methodCode7 = () => { return `la opción para conectarse.` }
const methodCode8 = () => { return `CONSEJO` }
const methodCode9 = () => { return `Si usa Termux, Replit, Linux, o Windows` }
const methodCode10 = () => { return `Use estos comandos para una ejecución directa:` }
const methodCode11 = (chalk) => { return `NO SE PERMITE NÚMEROS QUE NO SEAN ${chalk.bold.greenBright("1")} O ${chalk.bold.greenBright("2")}, TAMPOCO LETRAS O SÍMBOLOS ESPECIALES.\n${chalk.bold.yellowBright("CONSEJO: COPIE EL NÚMERO DE LA OPCIÓN Y PÉGUELO EN LA CONSOLA.")}` }
const methodCode12 = () => { return `Inicia con código QR` }
const methodCode13 = () => { return `Inicia con código de 8 dígitos` }
const methodCode14 = () => { return `Inicio predeterminado con opciones` }
const phNumber = (chalk) => { return `Configurar archivo ${chalk.bold.greenBright("config.js")} el número ingresado no tiene código de país. ${chalk.bold.yellowBright("Ejemplo: +593090909090")}` }
const phNumber2 = (chalk) => { return `Por favor, Ingrese el número de WhatsApp.\n${chalk.bold.yellowBright("CONSEJO: Copie el número de WhatsApp y péguelo en la consola.")}\n${chalk.bold.yellowBright("Ejemplo: +593090909090")}\n${chalk.bold.magentaBright('---> ')}` }
const phNumber3 = () => { return `Asegúrese de agregar el código de país.` }
const pairingCode = () => { return `CÓDIGO DE VINCULACIÓN:` }
...
//jadibot-serbot.js
const smsIniJadi = () => { return `⟣⊹⊹⊹✦ *SUB-BOT - QR* ✦⊹⊹⊹⟢
...
${global.policyGB}
`}
const smsIniJadi2 = () => { return `⟣⊹⊹⊹✦ *SUB-BOT - CÓDIGO* ✦⊹⊹⊹⟢
